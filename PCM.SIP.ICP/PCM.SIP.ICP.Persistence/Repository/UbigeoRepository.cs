...
namespace PCM.SIP.ICP.Persistence.Repository
{
    public class UbigeoRepository : IUbigeoRepository
    {
        ...
        public Response<List<dynamic>> GetListDepartamentos()
        {
            ...
            try
            {
                ...
                {
                    var query = "dbo.USP_SEL_UBIGEO_DEPARTAMENTO";
        ...
        public Response<List<dynamic>> GetListProvincias(Ubigeo entidad)
        {
            Response<List<dynamic>> retorno = new Response<List<dynamic>>();
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = "dbo.USP_SEL_UBIGEO_PROVINCIA";

                    var parameters = new DynamicParameters();

                    parameters.Add("departamento_inei", entidad.departamento_inei);
                    parameters.Add("error", dbType: DbType.Boolean, direction: ParameterDirection.Output);
                    parameters.Add("message", dbType: DbType.String, direction: ParameterDirection.Output, size: 500);
        ...
        public Response<List<dynamic>> GetListDistritos(Ubigeo entidad)
        {
            Response<List<dynamic>> retorno = new Response<List<dynamic>>();
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = "dbo.USP_SEL_UBIGEO_DISTRITO";

                    var parameters = new DynamicParameters();

                    parameters.Add("provincia_inei", entidad.provincia_inei);
                    parameters.Add("error", dbType: DbType.Boolean, direction: ParameterDirection.Output);
                    parameters.Add("message", dbType: DbType.String, direction: ParameterDirection.Output, size: 500);
