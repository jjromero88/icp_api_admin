...
{
    public class EntidadCoordinadorRepository : IEntidadCoordinadorRepository
    {
        private readonly DapperContext _context;

        public EntidadCoordinadorRepository(DapperContext context)
        {
            _context = context;
        }

        public Response Insert(EntidadCoordinador entidad)
        {
            ...
            try
            {
                ...
                {
                    var query = "dbo.USP_INS_ENTIDADCOORDINADOR";
        ...
        public Response Update(EntidadCoordinador entidad)
        {
            Response retorno = new Response();
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = "dbo.USP_UPD_ENTIDADCOORDINADOR";

                    var parameters = new DynamicParameters();

                    parameters.Add("entidadcoordinador_id", entidad.entidadcoordinador_id);
                    parameters.Add("entidad_id", entidad.entidad_id);
                    parameters.Add("modalidad_id", entidad.modalidad_id);
                    parameters.Add("profesion_id", entidad.profesion_id);
                    parameters.Add("nombres", entidad.nombres);
        ...
        public Response Delete(EntidadCoordinador entidad)
        {
            Response retorno = new Response();
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = "dbo.USP_DEL_ENTIDADCOORDINADOR";
        ...
        public Response<dynamic> GetById(EntidadCoordinador entidad)
        {
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = "dbo.USP_GET_ENTIDADCOORDINADOR";

                    var parameters = new DynamicParameters();

                    parameters.Add("entidadcoordinador_id", entidad.entidadcoordinador_id.Equals(0) ? (int?)null : entidad.entidadcoordinador_id);
                    parameters.Add("error", dbType: DbType.Boolean, direction: ParameterDirection.Output);
                    parameters.Add("message", dbType: DbType.String, direction: ParameterDirection.Output, size: 500);
        ...
        public Response<List<dynamic>> GetList(EntidadCoordinador entidad)
        {
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = "dbo.USP_SEL_ENTIDADCOORDINADOR";
