...
{
    public class EntidadCoordinadorIdRequestValidator : AbstractValidator<EntidadCoordinadorIdRequest>
    {
    ...
    public class EntidadCoordinadorInsertRequestValidator : AbstractValidator<EntidadCoordinadorInsertRequest>
    {
    ...
    public class EntidadCoordinadorUpdateRequestValidator : AbstractValidator<EntidadCoordinadorUpdateRequest>
    {
